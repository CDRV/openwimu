#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
/**************************************************************************************************
...
#line 14 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 15 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 16 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 17 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 18 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 19 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 20 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 21 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 22 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 23 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"

#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.h"
/**************************************************************************************************
...
#line 25 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 26 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
#line 27 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\TimeService\\timeservice.c"
...
const uint8 timeServUUID[2] =
{
  ((0x1805) & 0xFF), (((0x1805) >> 8) & 0xFF)
};

// Current Time characteristic
const uint8 currentTimeUUID[2] =
{
  ((0x2A2B) & 0xFF), (((0x2A2B) >> 8) & 0xFF)
};
...
static timeCBs_t *Time_AppCBs = 0;
...
static const gattAttrType_t timeService = { 2, timeServUUID };

// Current Time characteristic
static uint8 currentTimeProps = 0x02 | 0x10 | 0x08;
static uint8 currentTime[sizeof(currentTime_t)];
static gattCharCfg_t currentTimeClientCharCfg[( 3 + 1 )];
...
bStatus_t Time_AddService( void )
{
  ...
  GATTServApp_InitCharCfg( 0xFFFF, currentTimeClientCharCfg );

  // Register GATT attribute list and CBs with GATT Server App
  status = GATTServApp_RegisterService( timeAttrTbl,
                                        ( sizeof( timeAttrTbl ) / sizeof( gattAttribute_t ) ),
                                        &timeCBs );
...
bStatus_t Time_SetParameter( uint8 param, uint8 len, void *value )
{
  ...
  {
    case 0:
      if ( len == sizeof(currentTime_t) )
      {
        osal_memcpy( currentTime, value, sizeof(currentTime_t) );
        // See if Notification has been enabled
        GATTServApp_ProcessCharCfg( currentTimeClientCharCfg, currentTime, 0,
                                   timeAttrTbl, ( sizeof( timeAttrTbl ) / sizeof( gattAttribute_t ) ),
                                   0xFF );
      }
      else
      {
...
bStatus_t Time_GetParameter( uint8 param, void *value )
{
  ...
  switch ( param )
  {
    case 0:
      ...
      osal_memcpy( value, currentTime, sizeof(currentTime_t) );
                             ...
                             uint8 *pValue, uint8 *pLen, uint16 offset, uint8 maxLen )
{
  ...
  if ( uuid == 0x2A2B )
  {
    *pLen = sizeof(currentTime_t);
    (void) osal_memcpy( pValue, pAttr->pValue, sizeof(currentTime_t) );
  }
  else
  {
    status = 0x0a;
                                  ...
                                  uint8 *pValue, uint8 len, uint16 offset )
{
  ...
  switch ( uuid )
  {
      ...
      if ( status == 0x00 )
      {
        ...
        //*pCurValue = pValue[0];
        osal_memcpy( pCurValue, pValue, sizeof(currentTime_t) );
        
        osal_set_event(/*WIMU_TaskID*/10, 0x0010);
