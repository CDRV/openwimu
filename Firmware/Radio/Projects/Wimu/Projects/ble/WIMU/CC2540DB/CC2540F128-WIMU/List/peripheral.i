#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
/**************************************************************************************************
...
#line 44 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 45 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 46 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 47 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 48 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 49 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 50 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 51 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 52 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"

#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.h"
/**
 ...
 * @{
 */
#line 86 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.h"
...
#line 54 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
#line 55 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\Roles\\peripheral.c"
...
static uint8  gapRole_IRK[16];
static uint8  gapRole_SRK[16];
static uint32 gapRole_signCounter;
static uint8  gapRole_bdAddr[6];
static uint8  gapRole_AdvEnabled = 1;
static uint16 gapRole_AdvertOffTime = 30000;
static uint8  gapRole_AdvertDataLen = 3;
static uint8  gapRole_AdvertData[31] =
{
...
static uint8  gapRole_ScanRspData[31] = {0};
static uint8  gapRole_AdvEventType;
static uint8  gapRole_AdvDirectType;
static uint8  gapRole_AdvDirectAddr[6] = {0};
static uint8  gapRole_AdvChanMap;
static uint8  gapRole_AdvFilterPolicy;

static uint16 gapRole_ConnectionHandle = 0xFFFF;
static uint16 gapRole_RSSIReadRate = 0;

static uint8  gapRole_ConnectedDevAddr[6] = {0};

static uint8  gapRole_ParamUpdateEnable = 0;
static uint16 gapRole_MinConnInterval = 0x0006;
static uint16 gapRole_MaxConnInterval = 0x0C80;
static uint16 gapRole_SlaveLatency = 0;
static uint16 gapRole_TimeoutMultiplier = 1000;

static uint16 gapRole_ConnInterval = 0;
static uint16 gapRole_ConnSlaveLatency = 0;
static uint16 gapRole_ConnTimeout = 0;

static uint8 paramUpdateNoSuccessOption = 0;

// Application callbacks
static gapRolesCBs_t *pGapRoles_AppCGs = 0;
static gapRolesParamUpdateCB_t *pGapRoles_ParamUpdateCB = 0;
...
bStatus_t GAPRole_SetParameter( uint16 param, uint8 len, void *pValue )
{
  ...
  switch ( param )
  {
    case 0x301:
      if ( len == 16 )
      {
        (void) osal_memcpy( gapRole_IRK, pValue, 16 ) ;
      }
      else
      {
        ret = 0x18;
    ...
    case 0x302:
      if ( len == 16 )
      {
        (void) osal_memcpy( gapRole_SRK, pValue, 16 ) ;
      }
      else
      {
        ret = 0x18;
    ...
    case 0x305:
      if ( len == sizeof( uint8 ) )
      {
        ...
        if ( (oldAdvEnabled) && (gapRole_AdvEnabled == 0) )
        {
        ...
        else if ( (oldAdvEnabled == 0) && (gapRole_AdvEnabled) )
        {
          // Turn on Advertising
          ...
          {
            (void) osal_set_event( gapRole_TaskID, 0x0001 );
          }
        }
      }
      else
    ...
    case 0x307:
      if ( len <= 31 )
      {
        (void) osal_memset( gapRole_AdvertData, 0, 31 );
    ...
    case 0x308:
      if ( len <= 31 )
      {
        (void) osal_memset( gapRole_ScanRspData, 0, 31 );
    ...
    case 0x309:
      if ( (len == sizeof ( uint8 )) && (*((uint8*)pValue) <= 0x03) )
      {
    ...
    case 0x30B:
      if ( len == 6 )
      {
        (void) osal_memcpy( gapRole_AdvDirectAddr, pValue, 6 ) ;
      }
      else
      {
        ret = 0x18;
    ...
    case 0x30F:
      if ( len == sizeof ( uint16 ) )
      {
        ...
        if ( (gapRole_RSSIReadRate) && (gapRole_state == GAPROLE_CONNECTED) )
        {
          ...
          (void) osal_start_timerEx( gapRole_TaskID, 0x0002, gapRole_RSSIReadRate );
        }
      }
      else
      {
    ...
    case 0x313:
      {
        ...
        if ( len == sizeof ( uint16 ) && (latency < 500) )
        {
    ...
    case 0x314:
      {
        ...
        if ( len == sizeof ( uint16 )
            && (newTimeout >= 0x000a) && (newTimeout <= 0x0c80) )
        {
      ...
      case 0x319:
        {
          ...
          if ( len == sizeof ( uint8 ) && (req == 1) )
          {
            ...
            if ( osal_get_timeoutEx( gapRole_TaskID, 0x0008 ) == 0 )
            {             
              // Start connection update procedure
              gapRole_startConnUpdate( 0 );
              
              // Connection update requested by app, cancel such pending procedure (if active)
              (void) osal_stop_timerEx( gapRole_TaskID, 0x0004 );
            }
            else
            {
              ret = 0x16;
...
bStatus_t GAPRole_GetParameter( uint16 param, void *pValue )
{
  ...
  switch ( param )
  {
    ...
    case 0x301:
      (void) osal_memcpy( pValue, gapRole_IRK, 16 ) ;
      break;

    case 0x302:
      (void) osal_memcpy( pValue, gapRole_SRK, 16 ) ;
      break;
    ...
    case 0x304:
      (void) osal_memcpy( pValue, gapRole_bdAddr, 6 ) ;
      break;
    ...
    case 0x30B:
      (void) osal_memcpy( pValue, gapRole_AdvDirectAddr, 6 ) ;
      break;
    ...
    case 0x315:
      (void) osal_memcpy( pValue, gapRole_ConnectedDevAddr, 6 ) ;
      break;
...
void GAPRole_Init( uint8 task_id )
{
  ...
  gapRole_ConnectionHandle = 0xFFFF;

  GAP_RegisterForHCIMsgs( gapRole_TaskID );

  // Initialize the Profile Advertising and Connection Parameters
  gapRole_profileRole = 0x04;
  (void) osal_memset( gapRole_IRK, 0, 16 );
  (void) osal_memset( gapRole_SRK, 0, 16 );
  gapRole_signCounter = 0;
  gapRole_AdvEventType = 0x00;
  gapRole_AdvDirectType = 0x00;
  gapRole_AdvChanMap = (0x01 | 0x02 | 0x04);
  gapRole_AdvFilterPolicy = 0x00;

  // Restore Items from NV
  (void) osal_snv_read( 0x02, 16, gapRole_IRK );
  (void) osal_snv_read( 0x03, 16, gapRole_SRK );
  (void) osal_snv_read( 0x04, sizeof( uint32 ), &gapRole_signCounter );
}
...
uint16 GAPRole_ProcessEvent( uint8 task_id, uint16 events )
{
  ...
  if ( events & 0x8000 )
  {
    ...
    if ( (pMsg = osal_msg_receive( gapRole_TaskID )) != 0 )
    {
  ...
  if ( events & 0x4000 )
  {
    ...
    (void) osal_snv_write( 0x04, sizeof( uint32 ), &gapRole_signCounter );

    return ( events ^ 0x4000 );
  }
  ...
  if ( events & 0x0001 )
  {
    if ( gapRole_AdvEnabled )
    {
      ...
      (void) osal_memcpy( params.initiatorAddr, gapRole_AdvDirectAddr, 6 );
      params.channelMap = gapRole_AdvChanMap;
      params.filterPolicy = gapRole_AdvFilterPolicy;

      if ( GAP_MakeDiscoverable( gapRole_TaskID, &params ) != 0x00 )
      {
  ...
  switch ( pMsg->event )
  {
    case 0x91:
      if ( pMsg->status == 0x0E )
      {
        ...
        if ( pPkt->cmdOpcode == 0x1405 )
        {
          int8 rssi = (int8)pPkt->pReturnParam[3];

          if ( (gapRole_state == GAPROLE_CONNECTED) && (rssi != 127) )
          {
            // Report RSSI to app
    ...
    case 0xA2:
      {
        ...
        if ( pPkt->opcode == 0x13 )
        {
          ...
          if ( ( pRsp->result == 0x0001 ) &&
               ( paramUpdateNoSuccessOption == 2 ) )
          {
            // Cancel connection param update timeout timer
            (void) osal_stop_timerEx( gapRole_TaskID, 0x0008 );
          ...
          {
            uint16 timeout = GAP_GetParamValue( 5 );
            ...
            (void) osal_start_timerEx( gapRole_TaskID, 0x0008, timeout );
          }
        }
      }
      break;
...
static void gapRole_ProcessGAPMsg( gapEventHdr_t *pMsg )
{
  uint8 notify = 0;   // State changed notify the app? (default no)
    ...
    case 0x00:
      {
        ...
        if ( stat == 0x00 )
        {
          ...
          (void) osal_snv_write( 0x02, 16, gapRole_IRK );
          (void) osal_snv_write( 0x03, 16, gapRole_SRK );

          // Save off the information
          (void) osal_memcpy( gapRole_bdAddr, pPkt->devAddr, 6 );

          gapRole_state = GAPROLE_STARTED;

          // Update the advertising data
          stat = GAP_UpdateAdvertisingData( gapRole_TaskID,
                              1, gapRole_AdvertDataLen, gapRole_AdvertData );
        }
    ...
    case 0x02:
      {
        ...
        if ( pPkt->hdr.status == 0x00 )
        {
          if ( pPkt->adType )
          {
            // Setup the Response Data
            pPkt->hdr.status = GAP_UpdateAdvertisingData( gapRole_TaskID,
                              0, gapRole_ScanRspDataLen, gapRole_ScanRspData );
          }
          else
          {
            // Start advertising
        ...
        if ( pPkt->hdr.status == 0x00 )
        {
          ...
          else // GAP_END_DISCOVERABLE_DONE_EVENT
          {
            ...
            if ( gapRole_AdvertOffTime != 0 )
            {
              if ( ( gapRole_AdvEnabled ) )
              {
                (void) osal_start_timerEx( gapRole_TaskID, 0x0001, gapRole_AdvertOffTime );
              }
            }
            else
            {
    ...
    case 0x05:
      {
        ...
        if ( pPkt->hdr.status == 0x00 )
        {
          (void) osal_memcpy( gapRole_ConnectedDevAddr, pPkt->devAddr, 6 );
          ...
          if ( gapRole_ParamUpdateEnable == 1 )
          {
            // Get the minimum time upon connection establishment before the 
            // peripheral can start a connection update procedure.
            uint16 timeout = GAP_GetParamValue( 31 );
            
            osal_start_timerEx( gapRole_TaskID, 0x0004, timeout*1000 );
          }

          // Notify the Bond Manager to the connection
          (void) GAPBondMgr_LinkEst( pPkt->devAddrType, pPkt->devAddr, pPkt->connectionHandle, 0x04 );
        }
        else if ( pPkt->hdr.status == 0x31 )
        {
          // Set enabler to FALSE; device will become discoverable again when
          // this value gets set to TRUE
          gapRole_AdvEnabled = 0;
    ...
    case 0x06:
      {
        ...
        osal_memset( gapRole_ConnectedDevAddr, 0, 6 );
    ...
    case 0x07:
      {
        ...
        if ( pPkt->hdr.status == 0x00 )
        {
          ...
          if ( osal_get_timeoutEx( gapRole_TaskID, 0x0004 ) == 0 )
          {
            // Notify the application with the new connection parameters
            if ( pGapRoles_ParamUpdateCB != 0 )
            {
...
{    
  ...
  if ( ( minConnInterval >= 0x0006 ) &&
       ( minConnInterval < 0x0C80  ) &&
       ( maxConnInterval >= 0x0006 ) &&
