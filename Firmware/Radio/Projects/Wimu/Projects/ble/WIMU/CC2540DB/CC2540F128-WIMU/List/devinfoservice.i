#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
/**************************************************************************************************
...
#line 44 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 45 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 46 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 47 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 48 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 49 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
#line 50 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"

#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.h"
/**************************************************************************************************
...
#line 67 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.h"

// Device Information Service UUIDs
#line 79 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.h"
...
#line 52 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Projects\\ble\\Profiles\\DevInfo\\devinfoservice.c"
...
const uint8 devInfoServUUID[2] =
{
  ((0x180A) & 0xFF), (((0x180A) >> 8) & 0xFF)
};

// System ID
const uint8 devInfoSystemIdUUID[2] =
{
  ((0x2A23) & 0xFF), (((0x2A23) >> 8) & 0xFF)
};

// Model Number String
const uint8 devInfoModelNumberUUID[2] =
{
  ((0x2A24) & 0xFF), (((0x2A24) >> 8) & 0xFF)
};

// Serial Number String
const uint8 devInfoSerialNumberUUID[2] =
{
  ((0x2A25) & 0xFF), (((0x2A25) >> 8) & 0xFF)
};

// Firmware Revision String
const uint8 devInfoFirmwareRevUUID[2] =
{
  ((0x2A26) & 0xFF), (((0x2A26) >> 8) & 0xFF)
};

// Hardware Revision String
const uint8 devInfoHardwareRevUUID[2] =
{
  ((0x2A27) & 0xFF), (((0x2A27) >> 8) & 0xFF)
};

// Software Revision String
const uint8 devInfoSoftwareRevUUID[2] =
{
  ((0x2A28) & 0xFF), (((0x2A28) >> 8) & 0xFF)
};

// Manufacturer Name String
const uint8 devInfoMfrNameUUID[2] =
{
  ((0x2A29) & 0xFF), (((0x2A29) >> 8) & 0xFF)
};

// IEEE 11073-20601 Regulatory Certification Data List
const uint8 devInfo11073CertUUID[2] =
{
  ((0x2A2A) & 0xFF), (((0x2A2A) >> 8) & 0xFF)
};

// PnP ID
const uint8 devInfoPnpIdUUID[2] =
{
  ((0x2A50) & 0xFF), (((0x2A50) >> 8) & 0xFF)
};
...
static const gattAttrType_t devInfoService = { 2, devInfoServUUID };

// System ID characteristic
static uint8 devInfoSystemIdProps = 0x02;
static uint8 devInfoSystemId[8] = {0, 0, 0, 0, 0, 0, 0, 0};

// Model Number String characteristic
static uint8 devInfoModelNumberProps = 0x02;
static const uint8 devInfoModelNumber[] = "WIMU3";

// Serial Number String characteristic
static uint8 devInfoSerialNumberProps = 0x02;
static uint8 devInfoSerialNumber[2] = {0, 0};

// Firmware Revision String characteristic
static uint8 devInfoFirmwareRevProps = 0x02;
static uint8 devInfoFirmwareRev[29] = {0};

// Hardware Revision String characteristic
static uint8 devInfoHardwareRevProps = 0x02;
static uint8 devInfoHardwareRev[2] = {0, 0};

// Software Revision String characteristic
static uint8 devInfoSoftwareRevProps = 0x02;
static uint8 devInfoSoftwareRev[29] = {0};

// Manufacturer Name String characteristic
static uint8 devInfoMfrNameProps = 0x02;
static const uint8 devInfoMfrName[] = "CDRV";

// IEEE 11073-20601 Regulatory Certification Data List characteristic
static uint8 devInfo11073CertProps = 0x02;
static const uint8 devInfo11073Cert[] =
{
  254,      // authoritative body type
...
// System ID characteristic
static uint8 devInfoPnpIdProps = 0x02;
static uint8 devInfoPnpId[7] =
{
  1,                                      // Vendor ID source (1=Bluetooth SIG)
  ((0x000D) & 0xFF), (((0x000D) >> 8) & 0xFF),   // Vendor ID (Texas Instruments)
  ((0x0000) & 0xFF), (((0x0000) >> 8) & 0xFF),   // Product ID (vendor-specific)
  ((0x0110) & 0xFF), (((0x0110) >> 8) & 0xFF)    // Product version (JJ.M.N)
};
...
const gattServiceCBs_t devInfoCBs =
{
  ...
  0,               // Write callback function pointer
...
bStatus_t DevInfo_AddService( void )
{
  ...
  return GATTServApp_RegisterService( devInfoAttrTbl,
                                      ( sizeof( devInfoAttrTbl ) / sizeof( gattAttribute_t ) ),
                                      &devInfoCBs );
}
  ...
  switch (uuid)
  {
    case 0x2A23:
      ...
      else
      {
        ...
        *pLen = (((maxLen) < ((sizeof(devInfoSystemId) - offset))) ? (maxLen) : ((sizeof(devInfoSystemId) - offset)));
    ...
    case 0x2A24:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoModelNumber) - offset))) ? (maxLen) : ((sizeof(devInfoModelNumber) - offset)));
    ...
    case 0x2A25:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoSerialNumber) - offset))) ? (maxLen) : ((sizeof(devInfoSerialNumber) - offset)));
    ...
    case 0x2A26:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoFirmwareRev) - offset))) ? (maxLen) : ((sizeof(devInfoFirmwareRev) - offset)));
    ...
    case 0x2A27:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoHardwareRev) - offset))) ? (maxLen) : ((sizeof(devInfoHardwareRev) - offset)));;
    ...
    case 0x2A28:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoSoftwareRev) - offset))) ? (maxLen) : ((sizeof(devInfoSoftwareRev) - offset)));
    ...
    case 0x2A29:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoMfrName) - offset))) ? (maxLen) : ((sizeof(devInfoMfrName) - offset)));
    ...
    case 0x2A2A:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfo11073Cert) - offset))) ? (maxLen) : ((sizeof(devInfo11073Cert) - offset)));
    ...
    case 0x2A50:
      ...
      {
        // determine read length
        *pLen = (((maxLen) < ((sizeof(devInfoPnpId) - offset))) ? (maxLen) : ((sizeof(devInfoPnpId) - offset)));
