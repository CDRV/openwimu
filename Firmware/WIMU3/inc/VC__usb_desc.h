...
#ifndef __VC__USB_DESC_H
#define __VC__USB_DESC_H
...
#define VIRTUAL_COM_PORT_SIZ_STRING_VENDOR      10//38
#define VIRTUAL_COM_PORT_SIZ_STRING_PRODUCT     16//50
#define VIRTUAL_COM_PORT_SIZ_STRING_SERIAL      28//26
