#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\hal\\target\\CC2540EB\\hal_dma.c"
/**************************************************************************************************
  Filename:       hal_dma.c
...
/******************************************************************************
******************************************************************************/
#line 45 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\hal\\target\\CC2540EB\\hal_dma.c"
...
#line 48 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\hal\\target\\CC2540EB\\hal_dma.c"
...
void HalDmaInit( void )
{
  do { DMA0CFGH = (uint8)( (uint16)(&dmaCh0) >> 8 ); DMA0CFGL = (uint8)( (uint16)(&dmaCh0) & 0xFF ); } while (73 == -1);
  do { DMA1CFGH = (uint8)( (uint16)(dmaCh1234) >> 8 ); DMA1CFGL = (uint8)( (uint16)(dmaCh1234) & 0xFF); } while (74 == -1);
 ...
 * @return  None
 *****************************************************************************/
_Pragma("vector=0x43") __near_func __interrupt void halDmaIsr(void); _Pragma("vector=0x43") __near_func __interrupt void halDmaIsr(void)
{
  { halIntState_t _isrIntState = EA; do { EA = 1; } while (96 == -1);;
...
#line 117 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\hal\\target\\CC2540EB\\hal_dma.c"
