#line 1 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\osal\\common\\osal_bufmgr.c"
/**************************************************************************************************
...
#line 47 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\osal\\common\\osal_bufmgr.c"
...
#line 48 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\osal\\common\\osal_bufmgr.c"
...
#line 50 "D:\\Simon_Dev\\WIMuGPS\\Workspace\\openwimu\\Firmware\\Radio\\Projects\\Wimu\\Components\\osal\\common\\osal_bufmgr.c"
...
static bm_desc_t *bm_list_ptr = 0;
...
{
  bm_desc_t *loop_ptr;
  bm_desc_t *prev_ptr = 0;
  
  loop_ptr = bm_list_ptr;
  while ( loop_ptr != 0 )
  {
    if ( payload_ptr >= (void *)( (loop_ptr) + 1 ) &&
         payload_ptr <= (void *)( (uint8 *)( (loop_ptr) + 1 ) + (loop_ptr)->payload_len ) )
    {
...
void *osal_bm_adjust_header( void *payload_ptr, int16 size )
{
  ...
  if ( bd_ptr != 0 )
  {
    ...
    if ( new_payload_ptr >= (uint8 *)( (bd_ptr) + 1 ) &&
         new_payload_ptr <= (uint8 *)( (uint8 *)( (bd_ptr) + 1 ) + (bd_ptr)->payload_len ) )
    {
...
void *osal_bm_adjust_tail( void *payload_ptr, int16 size )
{
  ...
  if ( bd_ptr != 0 )
  {
    new_payload_ptr = (uint8 *)( (uint8 *)( (bd_ptr) + 1 ) + (bd_ptr)->payload_len ) - size;
...
static bm_desc_t *bm_desc_from_payload ( uint8 *payload_ptr )
{
  ...
  while ( loop_ptr != 0 )
  {
    if ( payload_ptr >= (uint8 *)( (loop_ptr) + 1 ) &&
         payload_ptr <= (uint8 *)( (uint8 *)( (loop_ptr) + 1 ) + (loop_ptr)->payload_len ) )
    {
      // item found
      break;
    }
