...
#define HAL_UART_DMA_RX_MAX        300
#endif
#if !defined HAL_UART_DMA_TX_MAX
#define HAL_UART_DMA_TX_MAX        50//HAL_UART_DMA_RX_MAX
#endif
...
static void HalUARTOpenDMA(halUARTCfg_t *config)
{
  ...
  */
  if (config->baudRate == HAL_UART_BR_14400 ||
      config->baudRate == HAL_UART_BR_28800 ||
      config->baudRate == HAL_UART_BR_57600 ||
      config->baudRate == HAL_UART_BR_115200 ||
  ...
  switch (config->baudRate)
  {
    ...
    case HAL_UART_BR_14400:
      UxGCR = 8;
      break;
    case HAL_UART_BR_19200:
    case HAL_UART_BR_28800:
      UxGCR = 9;
      break;
